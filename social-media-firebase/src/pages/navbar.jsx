...
function Navbar() {
    return (
        <div className="flex justify-center items-center h-16 bg-gray-800 shadow-lg">
            ...
            <Link to="/topic" className="mx-4 text-white hover:text-blue-400 text-lg font-semibold">Topic Management</Link>
            <Link to="/Notification" className="mx-4 text-white hover:text-blue-400 text-lg font-semibold">Notification History</Link>
